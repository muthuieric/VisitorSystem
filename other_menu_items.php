    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link <?php if ($currentPage == 'dashboard' || !isset($currentPage)) echo 'active'; ?>" href="dashboard.php">Dashboard</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php if ($currentPage == 'employees') echo 'active'; ?>" href="employee.php">Employees</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php if ($currentPage == 'organization') echo 'active'; ?>" href="myorganization.php">My Organization</a>
                </li>
                <li class="nav-item">

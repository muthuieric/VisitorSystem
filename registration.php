...
<body>
    ...
    <h1>Sign up</h1>
        ...
        if (isset($_POST["submit"])) {
           ...
           // Check if the selected role is "Guard", "Secretary", or "Administrator"
           if ($role !== "Guard" && $role !== "Secretary" && $role !== "Administrator") {
            array_push($errors, "Only Guards, Secretaries, or Administrators can register");
           }

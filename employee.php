...
<header class="d-flex justify-content-between my-4">
    <h1>Employee List</h1>
    <div>
        <a href="employeecreate.php" class="btn btn-primary">Add New Employee</a>
...
$sqlTotal = "SELECT COUNT(*) as total FROM employee";
...
$sqlSelect = "SELECT * FROM employee ORDER BY $sortField $sortOrder LIMIT $offset, $limit";
...
<table class="table table-bordered">
    <thead>
        <tr>
            ...
            <th><a href="?sort=jobtitle&order=<?php echo ($sortField == 'jobtitle' && $sortOrder == 'asc') ? 'desc' : 'asc'; ?>"><?php echo $sortLinks['jobtitle']; ?></a></th>
    ...
    <tbody id="myTable">
        ...
        while ($data = mysqli_fetch_array($result)) {
            ...
            <tr>
                ...
                <td>
                    <a href="employeeedit.php?id=<?php echo $data['id']; ?>" class="btn btn-warning">Edit</a>
                    <a href="employeedelete.php?id=<?php echo $data['id']; ?>" class="btn btn-danger">Delete</a>
                </td>
            </tr>
            <?php
        }
